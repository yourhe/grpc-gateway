...
func (*SimpleMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_echo_service_c7dbdd2013387b0d, []int{0}
}
...
func init() {
	proto.RegisterFile("examples/examplepb/echo_service.proto", fileDescriptor_echo_service_c7dbdd2013387b0d)
}

var fileDescriptor_echo_service_c7dbdd2013387b0d = []byte{
